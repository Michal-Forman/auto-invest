...
# Local
from api.dependencies import get_current_user_id, get_user_record, invalidate_user_record
...
def get_profile(user_id: str = Depends(get_current_user_id)) -> ProfileResponse:
    ...
    d: Dict[str, Any] = {k: v for k, v in dataclasses.asdict(record).items() if k != "id"}
